...
export function DashboardReviewContent() {
  ...
  const handleProceedToCheckout = () => {
    ...
    router.push('/dashboard/book/checkout');
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-neutral-900">Your Quote is Ready!</h1>
          <p className="text-neutral-600">Review your journey details and proceed to checkout</p>
        </div>
      </div>
