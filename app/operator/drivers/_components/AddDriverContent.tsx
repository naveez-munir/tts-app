...
import type { CreateDriverDto } from '@/lib/types';
...
export default function AddDriverContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-neutral-900">Add New Driver</h1>
        <p className="mt-1 text-neutral-600">
          Add a new driver to your team with all required documents and information.
        </p>
      </div>
