...
export function ConfirmationContent() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-accent-50 to-white pt-24 pb-12">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          {/* Success Animation */}
          <div className="text-center">
            <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-accent-100">
              <CheckCircle className="h-14 w-14 text-accent-600" />
            </div>
            <h1 className="text-3xl font-black text-neutral-900 sm:text-4xl">
              Booking Confirmed!
            </h1>
            <p className="mt-3 text-lg text-neutral-600">
              Thank you for booking with TTS Airport Transfers
            </p>
          </div>

          {/* Booking Reference Card */}
          <div className="mt-8 rounded-2xl bg-white p-6 shadow-lg ring-1 ring-neutral-200 sm:p-8">
            <div className="text-center">
              <p className="text-sm font-medium text-neutral-500">Your Booking Reference</p>
              <div className="mt-2 flex items-center justify-center gap-3">
                <span className="text-3xl font-black tracking-wider text-primary-600">
                  {reference}
                </span>
                <button
            ...
            <div className="mt-8 rounded-lg bg-neutral-50 p-4">
              <p className="text-sm text-neutral-600">
                ...
                <a href="tel:+441onal234567890" className="text-primary-600 hover:underline">
                  01onal 234 567 890
                </a>{' '}
                or email{' '}
