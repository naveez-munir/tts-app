 ...
 * Displays reasons to choose the service in a grid layout
 */

interface WhyChooseSectionProps {
  title: string;
  subtitle: string;
  reasons: readonly Feature[] | Feature[];
  columns?: 2 | 3 | 4 | 6;
  ...
  return (
    <section className={`${bgClass} py-16 sm:py-20 lg:py-24`}>
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12">
          <FeatureGrid features={reasons} columns={columns} variant={variant} iconColor={iconColor} />
        </div>
      </div>
    </section>
  );
